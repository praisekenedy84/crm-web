              ...
              <TableBody>
                {isLoading ? (
                  ...
                  <TableRow key={lr.id}>
                    ...
                    <TableCell className="text-muted-foreground">{lr.leave_type?.name ?? 'â€”'}</TableCell>
              ...
              <TableBody>
                {isLoading ? (
                  ...
                  <TableRow key={e.id}>
                    ...
                    <TableCell className="text-muted-foreground">{e.department || 'â€”'}</TableCell>
                    <TableCell className="text-muted-foreground">{e.job_title || 'â€”'}</TableCell>
